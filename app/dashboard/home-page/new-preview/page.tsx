'use client'
import { goods_list_byCategoryId, goods_new, update_goods_config } from "@/app/service/home-page/goods_config";
...
export default function Page() {
  ...
  return (
    <main>
      <h3 className='text-lg font-bold mb-5' >新品速览配置</h3>
