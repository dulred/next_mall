...
const columns: TableColumnsType = [
  ...
  { title: '展示价格', dataIndex: 'price', key: 'price' ,width: 100},
  { title: '折扣', dataIndex: 'discount', key: 'discount' ,width: 100},
  { title: '描述', dataIndex: 'description', key: 'description' ,width: 250},
  { title: '类别Id', dataIndex: 'categoryId', key: 'categoryId' ,width: 100},
  { title: '品牌Id', dataIndex: 'brandId', key: 'brandId',width: 100 },
  { title: '供应商Id', dataIndex: 'supplierId', key: 'supplierId' ,width: 100},
  { title: '排序值', dataIndex: 'rank', key: 'rank',width: 100 },
  { title: '评分', dataIndex: 'rating', key: 'rating' ,width: 100},
  { title: '是否下架', dataIndex: 'isDiscontinued', key: 'isDiscontinued' ,width: 100},
  { title: '上架时间', dataIndex: 'listedAt', key: 'listedAt',width: 300 },
  {
    title: '操作',
    key: 'operation',
    fixed: 'right',
...
const onReset = () => {
  ...
  const dataSource= t_data.map((item:any,index)=>{
    return {
      ...
      rank: item.rank,
      rating: item.rating,
      isDiscontinued: item.isDiscontinued === false ? '否' : '是',
  ...
  return (
    <main>
      <h3 className='text-lg font-bold mb-5' >商品管理</h3>
      <Flex justify='flex-end' style={{marginBottom:"30px"}}><Button type="primary" onClick={()=>showModal("-1")}>添加商品</Button></Flex>
        <Table
